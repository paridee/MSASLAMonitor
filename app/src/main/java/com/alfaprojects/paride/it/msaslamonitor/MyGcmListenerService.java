...
public class MyGcmListenerService extends GcmListenerService {
    ...
    public void onMessageReceived(String from, Bundle data) {
        ...
        Log.d(TAG, "json: " + data.getString("json"));
        String json =   data.getString("json");
        TaskInstance aTask  =   TaskInstance.loadFromJson(json);
        int id  =   Singletons.getDBSerializer(this.getApplicationContext()).addToDb(aTask);
        System.out.println("MyGcmListenerService task aggiunto al DB con id "+id);
    ...
    private void sendNotification(String message) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this)
                .setSmallIcon(R.drawable.ic_exclamationmark)
                .setContentTitle("MSA SLA Monitor")
